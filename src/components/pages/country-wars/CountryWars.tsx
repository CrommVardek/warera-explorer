...
import { buildWarGraph } from "../../../services/CountryWarsService";
import { AddCircleToNode, AddLabelsToNode, HighlightLinksOnHover } from "../../common/graph/GraphBuilderUtils";

interface CountryWarsProps { countries: Country[] }

export const CountryWars = ({ countries }: CountryWarsProps) => {
    const svgRef = useRef<SVGSVGElement | null>(null);

    const zoomGroupRef = useRef<SVGGElement | null>(null);

    useEffect(() => {
        const { nodes, edges } = buildWarGraph(countries);
